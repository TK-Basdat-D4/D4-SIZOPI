...
urlpatterns = [
    ...
    path('hewan/<str:id_hewan>/hentikan/', views.hentikan_adopsi_adopter, name='hentikan_adopsi_adopter'),
    path('adopter/', views.admin_list_adopter, name='admin_list_adopter'),
    path('adopter/<int:id_adopter>/riwayat/', views.admin_riwayat_adopsi, name='admin_riwayat_adopsi'),
    path('adopter/<int:id_adopter>/hapus/', views.hapus_adopter, name='hapus_adopter'),
    path('adopter/<int:id_adopter>/riwayat/<str:id_adopsi>/hapus/', views.hapus_riwayat_adopsi, name='hapus_riwayat_adopsi'),
]
